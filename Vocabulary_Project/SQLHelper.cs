...
namespace Vocabulary_Project 
{
    ...
    {
        private static string CONNECTION_STRING = @"Data Source=DESKTOP-V7M6UD9;Integrated Security=True";
        ...
        internal static void ExecuteNonQuery(SqlConnection conn, SqlCommand cmd, SqlParameter parameter)
        {
